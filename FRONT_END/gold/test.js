...
window.addEventListener("DOMContentLoaded", () => {
    let localStorageAfterParsing = JSON.parse(localStorage.getItem("Users Assets")) || [];
    localStorageAfterParsing.forEach(asset => addcard(asset));
});
...
function filterAssets() {
    ...
    let filtered = allAssets.filter(asset => {
        ...
        let matchesType = selectedType === "All" || asset.type === selectedType;
